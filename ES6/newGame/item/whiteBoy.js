export default class Whiteboy {
    ...
    constructor(x=0, y=0){
        this.#x = x;
        this.#y = y;
        this.#img = document.querySelector("#whiteboy");
    ...
    draw(ctx) {
        ...
        ctx.drawImage(this.#img, w*3, h , w, h, this.#x-w/2, this.#y-h/2, w*2, h*2); //h*this.#imgWalkingIndex 캐릭터 소스문서에서 세로로 하나씩 그림을 바꾸기 위한 코드이다.
